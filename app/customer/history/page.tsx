...
import { MapPin, Navigation, Clock, Star, ArrowLeft } from "lucide-react"
...
export default function RideHistoryPage() {
    ...
    useEffect(() => {
        ...
        loadRideHistory(customerId)
    }, [filter])

    const loadRideHistory = async (customerId: string) => {
        setLoading(true)
        try {
            let query = supabase
                .from("ride_requests")
            ...
            <header className="bg-card border-b border-border p-4 sticky top-0 z-10">
                <div className="max-w-4xl mx-auto flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Todos tus viajes anteriores</p>
                    </div>
                </div>
            </header>
                    ...
                    <Card key={ride.id} className="p-4 space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="font-semibold">{ride.driver?.full_name || "Conductor"}</p>
